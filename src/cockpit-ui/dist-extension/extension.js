...
var X0__namespace = /*#__PURE__*/ _interopNamespace(X0);
...
`
  ...
  function Ob(t) {
    console.log(`[dotenv@${Kf}][WARN] ${t}`);
  }
  function _s(t) {
    console.log(`[dotenv@${Kf}][DEBUG] ${t}`);
  }
  function Jf(t) {
  ...
  function Yf(t) {
    ...
    if (t && t.path && t.path.length > 0)
      {if (Array.isArray(t.path))
        {for (let r of t.path)
          {fd.existsSync(r) && (e = r.endsWith('.vault') ? r : `${r}.vault`);}}
      else {e = t.path.endsWith('.vault') ? t.path : `${t.path}.vault`;}}
    else {e = pd.resolve(process.cwd(), '.env.vault');}
    return fd.existsSync(e) ? e : null;
  }
  function Zf(t) {
    return t[0] === '~' ? pd.join(Bb.homedir(), t.slice(1)) : t;
  }
  function Mb(t) {
  ...
  function Ub(t) {
    let e = pd.resolve(process.cwd(), '.env'),
      r = 'utf8',
      n = !!(t && t.debug);
    t && t.encoding
      ? (r = t.encoding)
    ...
    let s = [e];
    if (t && t.path)
      {if (!Array.isArray(t.path)) {s = [Zf(t.path)];}
      else {
        s = [];
        for (let d of t.path) {s.push(Zf(d));}
      }}
    let o,
      i = {};
    for (let d of s)
      {try {
        let p = _e.parse(fd.readFileSync(d, { encoding: r }));
        _e.populate(i, p, t);
      } catch (p) {
  ...
  function Lb(t) {
    if (Jf(t).length === 0) {return _e.configDotenv(t);}
    let e = Yf(t);
    return e
      ? _e._configVault(t)
      : (Ob(
...
var md,
  ...
  Hs = D(() => {
    f();
    (md = /^bytes([1-9]|1[0-9]|2[0-9]|3[0-2])?$/),
      (hd =
...
function Vi(t) {
  var r;
  let e = t.type;
  if (rp.test(t.type) && 'components' in t) {
    e = '(';
...
var ip,
  ...
  js = D(() => {
    f();
    Hs();
    ip = /^error (?<name>[a-zA-Z$_][a-zA-Z0-9$_]*)\((?<parameters>.*?)\)$/;
    up = /^event (?<name>[a-zA-Z$_][a-zA-Z0-9$_]*)\((?<parameters>.*?)\)$/;
    fp =
      /^function (?<name>[a-zA-Z$_][a-zA-Z0-9$_]*)\((?<parameters>.*?)\)(?: (?<scope>external|public{1}))?(?: (?<stateMutability>pure|view|nonpayable|payable{1}))?(?: returns\s?\((?<returns>.*?)\))?$/;
    hp = /^struct (?<name>[a-zA-Z$_][a-zA-Z0-9$_]*) \{(?<properties>.*?)\}$/;
    yp =
      /^constructor\((?<parameters>.*?)\)(?:\s(?<stateMutability>payable{1}))?$/;
    wp = /^fallback\(\) external(?:\s(?<stateMutability>payable{1}))?$/;
...
function qs(t, e = {}) {
  if (pp(t)) {return jb(t, e);}
  if (dp(t)) {return qb(t, e);}
  if (ap(t)) {return Vb(t, e);}
  if (bp(t)) {return Gb(t, e);}
  if (vp(t)) {return Wb(t);}
  if (Ep(t)) {return { type: 'receive', stateMutability: 'payable' };}
...
function qb(t, e = {}) {
  ...
  let n = Zt(r.parameters),
    ...
    o = n.length;
  for (let i = 0; i < o; i++)
    {s.push(Yr(n[i], { modifiers: Cp, structs: e, type: 'event' }));}
...
function Yr(t, e) {
  var h, g, b, E;
  let r = kp(t, e == null ? void 0 : e.type, e == null ? void 0 : e.structs);
  ...
  else if (((d = s.type), (e == null ? void 0 : e.type) !== 'struct' && !bd(d)))
    {throw new Ki({ type: d });}
  if (s.modifier) {
    if (
      !(
    ...
    if (qi.test(c.type)) {n.push(c);}
      ...
      if (h in e) {
        ...
        n.push({
          ...c,
          type: `tuple${u != null ? u : ''}`,
          components: Bp((o = e[h]) != null ? o : [], e, new Set([...r, h])),
        });
      } else if (bd(h)) {n.push(c);}
...
function dx(t, e = false) {
  return e
    ? { h: Number(t & Sa), l: Number((t >> Dp) & Sa) }
    : { h: Number((t >> Dp) & Sa) | 0, l: Number(t & Sa) | 0 };
}
...
var Sa,
  ...
  Hp = D(() => {
    f();
    (Sa = BigInt(4294967295)), (Dp = BigInt(32));
    (Up = (t, e, r) => (t << r) | (e >>> (32 - r))),
      (Lp = (t, e, r) => (e << r) | (t >>> (32 - r))),
      (zp = (t, e, r) => (e << (r - 32)) | (t >>> (64 - r))),
      (_p = (t, e, r) => (t << (r - 32)) | (e >>> (64 - r)));
  });
var Mn,
  jp = D(() => {
    f();
...
var Kp,
  ...
  Ad = D(() => {
    ...
    ([bx, xx] = Mp(Yp, true)),
      ...
      (Zp = (t, e, r) => (r > 32 ? _p(t, e, r) : Lp(t, e, r)));
    (Oa = class t extends en {
      constructor(e, r, n, s = false, o = 24) {
        ...
        (this.state = new Uint8Array(200)), (this.state32 = qp(this.state));
      }
      keccak() {
        Ed || Cd(this.state32),
      ...
      rn(1, 72, 512 / 8),
      (Xp = (t, e, r) =>
        Gp((n = {}) => new Oa(e, t, n.dkLen === void 0 ? r : n.dkLen, true))),
      Xp(31, 168, 128 / 8),
      Xp(31, 136, 256 / 8);
  });
function Ee(t, e) {
  let r = e || 'hex',
    n = Da(Re(t, { strict: false }) ? Lt(t) : t);
...
function Bt(t, e) {
  if (kd.has(`${t}.${e}`)) {return kd.get(`${t}.${e}`);}
...
var Tx,
  ...
  sn = D(() => {
    ...
    si();
    on();
    (Tx = /^0x[a-fA-F0-9]{40}$/), ($d = new fr(8192));
  });
function lt(t) {
...
var am,
  ...
  Sd = D(() => {
    f();
    (am = /^bytes([1-9]|1[0-9]|2[0-9]|3[0-2])?$/),
      (Ua =
        /^(u?int)(8|16|24|32|40|48|56|64|72|80|88|96|104|112|120|128|136|144|152|160|168|176|184|192|200|208|216|224|232|240|248|256)?$/);
  });
function rt(t, e) {
...
function Cx({ params: t, values: e }) {
  let r = [];
  for (let n = 0; n < t.length; n++) {r.push(Rd({ param: t[n], value: e[n] }));}
  return r;
}
function Rd({ param: t, value: e }) {
  var n;
  let r = La(t.type);
  if (r) {
    let [s, o] = r;
...
function $x(t) {
  ...
  return { dynamic: false, encoded: Rr(Td(t)) };
}
...
function Sx(t, { param: e }) {
  ...
  for (let s = 0; s < e.components.length; s++) {
    let o = e.components[s],
      ...
      c = Rd({ param: o, value: t[i] });
    n.push(c), c.dynamic && (r = true);
  }
  return { dynamic: r, encoded: r ? Nd(n) : lt(n.map(({ encoded: s }) => s)) };
}
function La(t) {
  let e = t.match(/^(.*)\[(\d+)?\]$/);
  ...
  for (let c of o) {
    ...
    if (
      r.every((p, u) => {
        ...
        return h ? Fd(p, h) : false;
      })
    ) {
      if (i && 'inputs' in i && i.inputs) {
        let p = cm(c.inputs, i.inputs, r);
        if (p)
...
function cm(t, e, r) {
  for (let n in t) {
    ...
    if (
      ...
      {return cm(s.components, o.components, r[n]);}
    let i = [s.type, o.type];
    if (
...
function fm(t) {
  ...
  if (n) {
    ...
    if (!o) {throw new Yt(n, { docsPath: lm });}
    s = o;
  }
  if (s.type !== 'function') {throw new Yt(void 0, { docsPath: lm });}
...
var lm,
  pm = D(() => {
    ...
    Sr();
    an();
    lm = '/docs/contract/encodeFunctionData';
  });
function we(t) {
  let { args: e } = t,
...
function Dr(t, e) {
  let r = typeof e === 'string' ? je(e) : e,
    n = vo(r);
  if (pe(r) === 0 && t.length > 0) {throw new Ut();}
  if (pe(e) && pe(e) < 32)
    {throw new po({
...
function Nx(t) {
  ...
  return [Bt(me(Bd(e, -20))), 32];
}
function Fx(t, e, { length: r, staticPosition: n }) {
  if (!r) {
    let i = yr(t.readBytes(Dd)),
      c = n + i,
      d = c + xm;
    t.setPosition(c);
    let p = yr(t.readBytes(xm)),
      u = ui(e),
      h = 0,
      g = [];
    for (let b = 0; b < p; ++b) {
...
function Ox(t) {
  return [gm(t.readBytes(32), { size: 32 }), 32];
}
...
function Mx(t, e) {
  let r = e.type.startsWith('int'),
    ...
    s = t.readBytes(32);
  return [n > 48 ? hm(s, { signed: r }) : yr(s, { signed: r }), 32];
}
...
var Ga,
  ...
  Wa = D(() => {
    f();
    (Ga = { gwei: 9, wei: 18 }), (vm = { ether: -9, wei: 9 });
  });
function Za(t, e) {
  let r = t.toString(),
    n = r.startsWith('-');
        ...
        process(e, r) {
          ...
          for (let h = 0; h < 64; h++) {
            let g = tr(c, 6) ^ tr(c, 11) ^ tr(c, 25),
              b = (u + g + Pm(c, d, p) + jx[h] + pn[h]) | 0,
              T = ((tr(n, 2) ^ tr(n, 13) ^ tr(n, 22)) + km(n, s, o)) | 0;
            (u = p),
              (p = d),
              (d = c),
              (c = (i + b) | 0),
...
var ac,
  ...
  Im = D(() => {
    ...
    (ac = class extends en {
      constructor(e, r) {
        super(), (this.finished = false), (this.destroyed = false), Op(e);
        let n = tn(r);
      ...
      (jd = (t, e, r) => new ac(t, e).update(r).digest());
    jd.create = (t, e) => new ac(t, e);
  });
function Wn(t) {
  return (
    t instanceof Uint8Array ||
...
function hi(t) {
  if (typeof t !== 'string')
    {throw new Error('hex string expected, got ' + typeof t);}
  if (Fm) {return Uint8Array.fromHex(t);}
  let e = t.length,
    r = e / 2;
  if (e % 2)
  ...
  for (let s = 0, o = 0; s < r; s++, o += 2) {
    let i = Sm(t.charCodeAt(o)),
      c = Sm(t.charCodeAt(o + 1));
...
function Zd(t) {
  return zr(t), Nm(Zo(Uint8Array.from(t).reverse()));
}
function wr(t, e) {
...
var Wd,
  ...
  Ko = D(() => {
    ...
    qd = t => typeof t === 'bigint' && Wd <= t;
    (Kn = t => (Gd << BigInt(t)) - Gd),
      (Vd = t => new Uint8Array(t)),
      (Rm = t => Uint8Array.from(t));
    Vx = {
...
function lc(t, e, r = false, n = {}) {
  ...
  let { nBitLength: s, nByteLength: o } = Xd(t, e);
  if (o > 2048)
...
function Vm(t, e) {
  return {
    ...
    unsafeLadder(r, n, s = t.ZERO) {
      let o = r;
      for (; n > _m; ) {n & ol && (s = s.add(o)), (o = o.double()), (n >>= ol);}
      return s;
    },
    precomputeWindow(r, n) {
      let { windows: s, windowSize: o } = tl(n, e),
        i = [],
        c = r,
        d = c;
      for (let p = 0; p < s; p++) {
    ...
    wNAF(r, n, s) {
      ...
      for (let d = 0; d < c.windows; d++) {
        ...
        (s = p), h ? (i = i.add(el(b, n[E]))) : (o = o.add(el(g, n[u])));
      }
      return { p: o, f: i };
    },
    wNAFUnsafe(r, n, s, o = t.ZERO) {
      let i = tl(r, e);
      for (let c = 0; c < i.windows && s !== _m; c++) {
        let { nextN: d, offset: p, isZero: u, isNeg: h } = Hm(s, c, i);
        if (((s = d), !u)) {
          let g = n[p];
    ...
    getPrecomputes(r, n, s) {
      let o = rl.get(n);
      return (
        o || ((o = this.precomputeWindow(n, r)), r !== 1 && rl.set(n, s(o))), o
      );
    },
    wNAFCached(r, n, s) {
      let o = nl(r);
...
function sl(t) {
  return (
    ...
    Object.freeze({ ...Xd(t.n, t.nBitLength), ...t, p: t.Fp.ORDER })
  );
}
var _m,
  ol,
  ...
  Wm = D(() => {
    ...
    gi();
    Ko();
    (_m = BigInt(0)), (ol = BigInt(1));
    (rl = new WeakMap()), (qm = new WeakMap());
  });
function Zm(t) {
...
function Jm(t) {
  ...
  function J(z, q, j = Z) {
    let { seed: ee, k2sig: re } = M(z, q, j),
      de = e;
    return Dm(de.hash.outputLen, de.nByteLength, de.hmac)(ee, re);
  }
  ...
  function te(z, q, j, ee = G) {
    ...
    let { r: At, s: ne } = Ie,
      ...
      Gt = i(At * mt),
      Wt =
        (Br = d.BASE.multiplyAndAddUnsafe(Ct, Ft, Gt)) == null
          ? void 0
          : Br.toAffine();
...
function aw(t) {
  return { hash: t, hmac: (e, ...r) => jd(t, e, Vp(...r)), randomBytes: Fa };
}
function Xm(t, e) {
  let r = n => Jm({ ...t, ...aw(n) });
  return { ...r(e), create: r };
...
function rh(t, e, r) {
  ...
  return {
    ...
    encodeToCurve(n, s) {
      let o = eh(n, 1, { ...r, DST: r.encodeDST, ...s }),
...
function dl(t) {
  let e = Yn.utils.normPrivateKeyToScalar(t),
    r = fl.fromPrivateKey(e);
  return { scalar: r.hasEvenY() ? e : xi(-e), bytes: ll(r) };
}
function ch(t) {
  _r('x', t, bi, wi);
  let e = cl(t * t),
...
function mw(t, e, r = Fa(32)) {
  let n = Ve('message', t),
    { bytes: s, scalar: o } = dl(e),
    i = Ve('auxRand', r, 32),
    c = ul(o ^ Jo(hc('BIP0340/aux', i))),
    d = hc('BIP0340/nonce', c, s, n),
    p = xi(Jo(d));
  if (p === ah) {throw new Error('sign failed: k is zero');}
  let { bytes: u, scalar: h } = dl(p),
    g = uh(u, s, n),
    b = new Uint8Array(64);
  if ((b.set(u, 0), b.set(ul(xi(h + g * o)), 32), !dh(b, n, s)))
...
var wi,
  ...
  pl = D(() => {
    ...
    (wi = BigInt(
      ...
      (mc = BigInt(2)),
      (oh = (t, e) => (t + e / mc) / e);
    (yn = lc(wi, void 0, void 0, { sqrt: ih })),
      (Yn = Xm(
        {
          a: BigInt(0),
          b: BigInt(7),
      ...
      (ah = BigInt(0)),
      (sh = {});
    (ll = t => t.toRawBytes(true).slice(1)),
      (ul = t => wr(t, 32)),
      (cl = t => Fe(t, wi)),
      (xi = t => Fe(t, pc)),
      (fl = Yn.ProjectivePoint),
      (fw = (t, e, r) => fl.BASE.multiplyAndAddUnsafe(t, e, r));
    Jo = bt;
    (hw = {
      getPublicKey: pw,
      sign: mw,
...
var vh,
  Th = D(() => {
    ...
    BigInt(2) ** (BigInt(8) - BigInt(1)) - BigInt(1),
      ...
      BigInt(2) ** BigInt(240) - BigInt(1),
      BigInt(2) ** BigInt(248) - BigInt(1),
      (vh = BigInt(2) ** BigInt(256) - BigInt(1));
  });
function xt(t) {
  let {
      account: e,
  ...
  if (
    ...
    {throw new Ya();}
  if (n && n > vh) {throw new bn({ maxFeePerGas: n });}
  if (s && n && s > n)
...
function wt(t) {
  ...
  if (n) {
    ...
    if (!c) {throw new Yt(n, { docsPath: yl });}
    o = c;
  }
  if (o.type !== 'function') {throw new Yt(void 0, { docsPath: yl });}
  if (!o.outputs) {throw new go(o.name, { docsPath: yl });}
...
var yl,
  An = D(() => {
    ...
    di();
    an();
    yl = '/docs/contract/decodeFunctionResult';
  });
var Ei,
  Sc,
  Fh,
...
function to(t) {
  ...
  if (!s) {throw new pa({ docsPath: vl });}
  if (!('inputs' in s)) {throw new Ws({ docsPath: vl });}
  if (!s.inputs || s.inputs.length === 0) {throw new Ws({ docsPath: vl });}
  let o = rt(s.inputs, r);
  return nr([n, o]);
}
var vl,
  Uc = D(() => {
    ...
    or();
    mr();
    vl = '/docs/contract/encodeDeployData';
  });
function qt({ blockNumber: t, chain: e, contract: r }) {
  var s;
...
function Pl(t) {
  ...
  if (r) {
    ...
    if (!d) {throw new Zs(r, { docsPath: Al });}
    s = d;
  }
  if (s.type !== 'error') {throw new Zs(void 0, { docsPath: Al });}
  let o = He(s),
    i = hr(o),
    c = '0x';
  if (n && n.length > 0) {
    if (!s.inputs) {throw new ya(s.name, { docsPath: Al });}
    c = rt(s.inputs, n);
  }
  return nr([i, c]);
}
var Al,
  jh = D(() => {
    ...
    Sr();
    an();
    Al = '/docs/contract/encodeErrorResult';
  });
function qh(t) {
  ...
  if (r) {
    ...
    if (!i) {throw new Yt(r, { docsPath: kl });}
    s = i;
  }
  if (s.type !== 'function') {throw new Yt(void 0, { docsPath: kl });}
  if (!s.outputs) {throw new go(s.name, { docsPath: kl });}
  let o = (() => {
...
var kl,
  Vh = D(() => {
    ...
    mr();
    an();
    kl = '/docs/contract/encodeFunctionResult';
  });
async function Gh(t) {
  ...
  return (
    ...
    qh({ abi: Sc, functionName: 'query', result: [s, o] })
  );
}
function Bw(t) {
  return t.name === 'HttpRequestError' && t.status
    ? Pl({ abi: Sc, errorName: 'HttpError', args: [t.status, t.shortMessage] })
    : Pl({
        abi: [Ha],
        errorName: 'Error',
...
async function Zh({ data: t, sender: e, urls: r }) {
  var s;
  ...
  for (let o = 0; o < r.length; o++) {
    ...
    try {
      ...
      n = new zt({ body: d, details: u.message, url: i });
    }
  }
  throw n;
}
  ...
  try {
    ...
    let j = Dw(q),
      { offchainLookup: ee, offchainLookupSignature: re } =
        await Promise.resolve().then(() => (Jh(), Kh));
    if (
      t.ccipRead !== false &&
...
async function Nw(t, e) {
  ...
  if (!p) {
    ...
    p = qt({ blockNumber: s, chain: t.chain, contract: 'multicall3' });
  }
  ...
  V0.exports = (function () {
    ...
    function r(n) {
      var s = arguments.length > 1 ? arguments[1] : {},
        ...
        k = function (a) {
          dd(tt('ObjectPath', a, Qe, et));
        },
        B = function (a) {
          dd(tt('ArrayPath', a, Qe, et));
        },
        F = function (a, m) {
          return a.concat(m);
        },
        ...
        df = 'T',
        lf = { type: 'literal', value: 'T', description: '"T"' },
        vy = 'Z',
...
`;
        ...
        Y = 0,
        Ds = 0,
        od = { line: 1, column: 1, seenCR: false },
        Mi = 0,
        sd = [],
        U = 0,
        L = {},
...
`
        ...
        return (
          Ds !== a &&
            (Ds > a && ((Ds = 0), (od = { line: 1, column: 1, seenCR: false })),
            m(od, Ds, a),
            (Ds = a)),
          od
        );
      ...
      function Cf() {
        ...
        for (a = l, m = [], y = Af(); y !== o; ) {m.push(y), (y = Af());}
        return (
          m !== o && ((Y = a), (m = p())),
          (a = m),
      ...
      function Df() {
        var a,
          ...
          R = L[$];
        if (R) {return (l = R.nextPos), R.result;}
        for (a = l, m = [], y = Ot(); y !== o; ) {m.push(y), (y = Ot());}
        if (m !== o)
          {if (((y = ao()), y !== o)) {
            for (w = [], A = Ot(); A !== o; ) {w.push(A), (A = Ot());}
            w !== o ? ((Y = a), (m = of(y)), (a = m)) : ((l = a), (a = u));
          } else {(l = a), (a = u);}}
        else {(l = a), (a = u);}
        return (L[$] = { nextPos: l, result: a }), a;
      }
          ...
          {if (((y = ao()), y !== o)) {
            ...
            if (w !== o)
              {if (
                ...
                for ($ = [], R = Ot(); R !== o; ) {$.push(R), (R = Ot());}
                $ !== o ? ((Y = a), (m = of(y)), (a = m)) : ((l = a), (a = u));
              } else {(l = a), (a = u);}}
            else {(l = a), (a = u);}
          } else {(l = a), (a = u);}}
        else {(l = a), (a = u);}
...
Sr();
an();
var um = '/docs/contract/encodeEventTopics';
function gr(t) {
  var d, p, u;
  ...
  if (r) {
    ...
    if (!h) {throw new Ks(r, { docsPath: um });}
    s = h;
  }
  if (s.type !== 'event') {throw new Ks(void 0, { docsPath: um });}
  let o = He(s),
    i = nn(o),
    c = [];
  if (n && 'inputs' in s) {
      ...
      (c =
        (u =
          h == null
            ...
            : h.map((b, E) =>
                Array.isArray(g[E])
                  ? g[E].map((T, P) => dm({ param: b, value: g[E][P] }))
                  : typeof g[E] !== 'undefined' && g[E] !== null
                    ? dm({ param: b, value: g[E] })
                    : null
              )) != null
          ? u
          : []);
...
function dm({ param: t, value: e }) {
  if (t.type === 'string' || t.type === 'bytes') {return Ee(Lt(e));}
...
dt();
se();
async function mh({ hash: t, signature: e }) {
  let r = Re(t) ? t : Le(t),
    { secp256k1: n } = await Promise.resolve().then(() => (pl(), fh));
  return `0x${(() => {
...
async function gc({ hash: t, signature: e }) {
  return Am(await mh({ hash: t, signature: e }));
}
f();
or();
Ke();
...
function gh(t) {
  return Array.isArray(t) ? ww(t.map(e => gh(e))) : vw(t);
}
function ww(t) {
...
function bh(t) {
  ...
  let { chainId: e, nonce: r, to: n } = t,
    ...
    o = Ee(nr(['0x05', hh([e ? H(e) : '0x', s, r ? H(r) : '0x'])]));
  return n === 'bytes' ? je(o) : o;
}
async function yc(t) {
  let { authorization: e, signature: r } = t;
  return gc({ hash: bh(e), signature: r != null ? r : e });
}
se();
f();
f();
  ...
  if (o === 'eip1559') {
    ...
    let v =
        typeof (s == null ? void 0 : s.maxPriorityFeePerGas) === 'bigint'
          ...
          : await hl(t, { block: u, chain: n, request: s }),
      C = p(u.baseFeePerGas);
    return {
      maxFeePerGas:
...
function kh(t) {
  ...
  let { commitments: e, version: r } = t,
    ...
    s = [];
  for (let i of e) {s.push(Ph({ commitment: i, to: n, version: r }));}
  return s;
}
f();
f();
...
function Bh(t) {
  ...
  let { data: e, kzg: r, to: n } = t,
    s = (d = t.blobs) != null ? d : $h({ data: e, to: n }),
...
var gl = ['blobVersionedHashes', 'chainId', 'fees', 'gas', 'nonce', 'type'],
  Sh = new Map();
...
async function us(t, e) {
  ...
  try {
    ...
    throw xh(c, { ...e, account: n, chain: t.chain });
  }
}
...
function ut(t, e, r) {
  let n = ++Mw,
    ...
    c = s();
  if (($l.set(t, [...c, { id: n, fns: e }]), c && c.length > 0)) {return i;}
  let d = {};
  for (let u in e)
    {d[u] = (...h) => {
      var b, E;
  ...
  let p = r(d);
  return typeof p === 'function' && Xh.set(t, p), i;
}
f();
f();
async function Ai(t) {
...
function Vt(t, { emitOnBegin: e, initialWaitTime: r, interval: n }) {
  let s = true,
    o = () => (s = false);
  return (
    (async () => {
...
async function eg(t, { cacheKey: e, cacheTime: r = Number.POSITIVE_INFINITY }) {
  let n = Qh(e),
    s = n.response.get();
...
async function Er(t, { cacheTime: e = t.cacheTime } = {}) {
  let r = await eg(() => t.request({ method: 'eth_blockNumber' }), {
    cacheKey: zw(t.uid),
    cacheTime: e,
  });
  return BigInt(r);
...
f();
dt();
var Il = { '0x0': 'reverted', '0x1': 'success' };
function ng(t) {
  let e = {
    ...t,
    blockNumber: t.blockNumber ? BigInt(t.blockNumber) : null,
    ...
    status: t.status ? Il[t.status] : null,
    type: t.type ? ml[t.type] || t.type : null,
  };
  return (
...
async function og(t, e) {
  ...
  return (
    (u = o
      ? setTimeout(() => {
          h(), clearTimeout(u), p(new Sl({ id: r }));
        }, o)
      : void 0),
    await c
  );
...
si();
var Qc = new fr(8192);
function sg(t, { enabled: e = true, id: r }) {
  if (!e || !r) {return t();}
...
function ag(
  ...
  return {
    ...
    request: ig(n, { methods: e, retryCount: s, retryDelay: o, uid: p }),
    value: d,
  };
}
f();
  ...
  return {
    async request(r) {
      ...
      try {
        ...
        throw T instanceof zt || T instanceof fi
          ? T
          : new zt({ body: n, cause: T, url: t });
      }
    },
  };
}
function xs(t, e = {}) {
  ...
  return ({ chain: h, retryCount: g, timeout: b }) => {
    ...
    if (!C) {throw new eu();}
    let k = ug(C, { fetchOptions: n, onRequest: c, onResponse: d, timeout: v });
    return ag(
      {
        key: s,
        methods: o,
...
function In(t) {
  ...
  for (let o = 0; o < s.length; o++) {
    let i = er(s[o]);
    i.byteLength > 255 && (i = er(dg(lg(s[o])))),
      (r[n] = i.length),
      r.set(i, n + 1),
      (n += i.length + 1);
  }
...
async function fg(t, e) {
  let {
    ...
    p = (() => {
      ...
      return qt({ blockNumber: r, chain: d, contract: 'ensUniversalResolver' });
    })(),
...
function Nl({ uri: t, gatewayUrls: e }) {
  let r = Vw.test(t);
  if (r) {return { uri: t, isOnChain: true, isEncoded: r };}
  let n = pg(e == null ? void 0 : e.ipfs, 'https://ipfs.io'),
    s = pg(e == null ? void 0 : e.arweave, 'https://arweave.net'),
    o = t.match(jw),
    {
      protocol: i,
      subpath: c,
...
async function mg({ gatewayUrls: t, uri: e }) {
  try {
    ...
    return await ou({ gatewayUrls: t, uri: Fl(r) });
  } catch {
    throw new Ts({ uri: e });
  }
}
async function ou({ gatewayUrls: t, uri: e }) {
  let { uri: r, isOnChain: n } = Nl({ uri: e, gatewayUrls: t });
...
async function yg(t, { gatewayUrls: e, record: r }) {
...
async function su(t, e) {
  ...
  try {
    let h = {
        ...
        args: [
          Le(In(o)),
          we({ abi: bl, functionName: 'text', args: [vs(o), s] }),
          i != null ? i : [hs],
        ],
        blockNumber: r,
        blockTag: n,
    ...
    let E = wt({ abi: bl, functionName: 'text', data: b[0] });
    return E === '' ? null : E;
  } catch (h) {
    if (c) {throw h;}
    if (ws(h, 'resolve')) {return null;}
...
async function bg(
  ...
  if (!d) {return null;}
  try {
    return await yg(t, { record: d, gatewayUrls: n });
  } catch {
    return null;
  }
}
...
async function wg(t, e) {
  let { blockNumber: r, blockTag: n, name: s } = e,
    ...
    i = (() => {
      ...
      return qt({ blockNumber: r, chain: o, contract: 'ensUniversalResolver' });
    })(),
...
f();
se();
async function Ol(t, { address: e, blockNumber: r, blockTag: n = 'latest' }) {
  let s = r !== void 0 ? H(r) : void 0,
    o = await t.request(
...
function $g(t) {
  ...
  return (
    ...
    n !== 'EIP712Domain' && o.push(Bg({ data: r, primaryType: n, types: s })),
    Ee(lt(o))
  );
}
function Jw({ domain: t, types: e }) {
  return Bg({ data: t, primaryType: 'EIP712Domain', types: e });
}
function Bg({ data: t, primaryType: e, types: r }) {
  let n = Ig({ data: t, primaryType: e, types: r });
  return Ee(n);
}
function Ig({ data: t, primaryType: e, types: r }) {
  let n = [{ type: 'bytes32' }],
    s = [Yw({ primaryType: e, types: r })];
  for (let o of r[e]) {
    let [i, c] = Rg({ types: r, name: o.name, type: o.type, value: t[o.name] });
    n.push(i), s.push(c);
  }
  return rt(n, s);
}
...
function Sg({ primaryType: t, types: e }, r = new Set()) {
  let n = t.match(/^\w*/u),
    s = n == null ? void 0 : n[0];
  if (r.has(s) || e[s] === void 0) {return r;}
  r.add(s);
  for (let o of e[s]) {Sg({ primaryType: o.type, types: e }, r);}
  return r;
}
function Rg({ types: t, name: e, type: r, value: n }) {
  if (t[r] !== void 0)
    {return [{ type: 'bytes32' }, Ee(Ig({ data: n, primaryType: r, types: t }))];}
  if (r === 'bytes')
    {return (
  ...
  if (r.lastIndexOf(']') === r.length - 1) {
    let s = r.slice(0, r.lastIndexOf('[')),
      o = n.map(i => Rg({ name: e, type: s, types: t, value: i }));
    return [
      { type: 'bytes32' },
      Ee(
        rt(
...
f();
f();
var Fg = `Ethereum Signed Message:
`;
or();
Jt();
se();
...
async function jg(t, e) {
  ...
  if (!u) {
    ...
    u = qt({ blockNumber: s, chain: t.chain, contract: 'multicall3' });
  }
  let h = [[]],
    g = 0,
    b = 0;
...
f();
function Zg(t, e) {
  if (Ul(t) > e) {throw new bu({ givenSize: Ul(t), maxSize: e });}
}
...
function e0(t, e = {}) {
  let { size: r } = e,
    n = o1.encode(t);
  return typeof r === 'number' ? (Zg(n, r), a1(n, r)) : n;
}
function a1(t, e) {
  return Kg(t, { dir: 'right', size: e });
}
function Ul(t) {
  return t.length;
}
...
function Gr(t, e) {
  return _l(t, { dir: 'left', size: e });
}
function Ar(t, e) {
  return _l(t, { dir: 'right', size: e });
}
function Ps(t, e, r, n = {}) {
  let { strict: s } = n;
  Jg(t, e);
...
var Tu = class extends ge {
    constructor(e) {
      super(
        `Value \`${typeof e === 'object' ? Wg(e) : e}\` of type \`${typeof e}\` is an invalid hex type.`,
...
function r0(t) {
  return {
    ...
    ...(t.withdrawals && { withdrawals: t.withdrawals.map(t0) }),
  };
}
Ne();
$e();
...
async function Si(t, e) {
  ...
  try {
    let d = [];
    for (let g of s) {
      let b = g.blockOverrides ? r0(g.blockOverrides) : void 0,
        E = g.calls.map(P => {
          var B;
          let v = P,
...
function ks(t, e = {}) {
  let { strict: r = true } = e;
  if (!h1.test(t)) {throw new $u({ address: t, cause: new jl() });}
  if (r) {
    if (t.toLowerCase() === t) {return;}
    if (o0(t) !== t) {throw new $u({ address: t, cause: new ql() });}
  }
}
function o0(t) {
...
function Gl(t, e, r) {
  for (let n in t) {
    ...
    if (
      ...
      {return Gl(s.components, o.components, r[n]);}
    let i = [s.type, o.type];
    if (
      i.includes('address') && i.includes('bytes20')
        ? true
  ...
  for (let p of i) {
    ...
    if (
      ...
      if (c && 'inputs' in c && c.inputs) {
        let h = Gl(p.inputs, c.inputs, n);
        if (h)
          {throw new Wl({ abiItem: p, type: h[0] }, { abiItem: c, type: h[1] });}
      }
      c = p;
    }
  }
...
f();
var a0 = /^(.*)\[([0-9]*)\]$/,
  c0 = /^bytes([1-9]|1[0-9]|2[0-9]|3[0-2])?$/,
  Nu =
    /^(u?int)(8|16|24|32|40|48|56|64|72|80|88|96|104|112|120|128|136|144|152|160|168|176|184|192|200|208|216|224|232|240|248|256)?$/;
BigInt(2) ** (BigInt(8) - BigInt(1)) - BigInt(1);
BigInt(2) ** (BigInt(16) - BigInt(1)) - BigInt(1);
...
BigInt(2) ** BigInt(256) - BigInt(1);
f();
function u0({ checksumAddress: t, parameters: e, values: r }) {
  let n = [];
  for (let s = 0; s < e.length; s++)
    {n.push(Kl({ checksumAddress: t, parameter: e[s], value: r[s] }));}
  return n;
}
function Kl({ checksumAddress: t = false, parameter: e, value: r }) {
  var o;
  let n = e,
    s = P1(n.type);
  if (s) {
...
function w1(t, e) {
  ...
  for (let d = 0; d < t.length; d++) {
    let p = Kl({ checksumAddress: r, parameter: s, value: t[d] });
...
function A1(t, e) {
  ...
  for (let i = 0; i < n.components.length; i++) {
    let c = n.components[i],
      ...
      p = Kl({ checksumAddress: r, parameter: c, value: t[d] });
...
function Uu(t, e, r) {
  ...
  let s = u0({ checksumAddress: n, parameters: t, values: e }),
    o = Fu(s);
...
Ne();
f();
var p0 = '0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee',
...
async function m0(t, e) {
  ...
  let u = p
      ? d0(l0('constructor(bytes, bytes)'), {
          bytecode: Nc,
          args: [N1, f0(so('function getBalance(address)'), [p.address])],
        })
      : void 0,
    h = i
      ? await Promise.all(
          e.calls.map(async ne => {
            ...
            return Te.map(({ address: mt, storageKeys: Ft }) =>
              Ft.length > 0 ? mt : null
            );
          })
  ...
  for (let [ne, Te] of z.entries()) {
    ...
    let Ft = q[ne - 1],
      ...
      cr =
        ne === 0
          ? { address: p0, decimals: 18, symbol: 'ETH' }
          : {
              address: h[ne - 1],
              decimals: Wt || Ft ? Number(Ft != null ? Ft : 1) : void 0,
...
dt();
Ke();
function h0({ r: t, s: e, to: r = 'hex', v: n, yParity: s }) {
  let o = (() => {
      if (s === 0 || s === 1) {return s;}
  ...
  let {
    ...
    p = Re(i)
      ...
      : typeof i === 'object' && 'r' in i && 's' in i
        ...
        : me(i),
    u = await (async () =>
      (!n && !s) || Dg(p) ? p : Mg({ address: n, data: s, signature: p }))();
  try {
    let E = c
        ? {
            to: c,
            data: we({ abi: wl, functionName: 'isValidSig', args: [r, o, u] }),
            ...d,
          }
        : { data: to({ abi: wl, args: [r, o, u], bytecode: Lh }), ...d },
      { data: T } = await V(t, Tr, 'call')(E);
    return vd(T != null ? T : '0x0');
  } catch (E) {
    try {
...
async function y0(t, e) {
  let {
    ...
    h = $g({ message: i, primaryType: c, types: d, domain: p });
  return Bs(t, {
    address: r,
    factory: n,
    factoryData: s,
...
async function C0(t, e) {
  ...
  if (
    !u.address ||
    !E0({ address: r, domain: n, message: u, nonce: o, scheme: i, time: d })
  )
    {return false;}
  let g = hu(s);
...
function A0(t) {
  return {
    ...
    createBlockFilter: () => vg(t),
    createContractEventFilter: e => za(t, e),
    createEventFilter: e => au(t, e),
    createPendingTransactionFilter: () => cu(t),
    estimateContractGas: e => Rh(t, e),
    estimateGas: e => us(t, e),
    getBalance: e => Bc(t, e),
    getBlobBaseFee: () => Tg(t),
    getBlock: e => at(t, e),
    getBlockNumber: e => Er(t, e),
    getBlockTransactionCount: e => Eg(t, e),
    getBytecode: e => Ol(t, e),
    getChainId: () => jt(t),
    getCode: e => Ol(t, e),
    getContractEvents: e => Ic(t, e),
    getEip712Domain: e => Cg(t, e),
    getEnsAddress: e => fg(t, e),
    getEnsAvatar: e => bg(t, e),
    getEnsName: e => xg(t, e),
    getEnsResolver: e => wg(t, e),
    getEnsText: e => su(t, e),
    getFeeHistory: e => Pg(t, e),
    estimateFeesPerGas: e => Ch(t, e),
    getFilterChanges: e => kn(t, e),
    getFilterLogs: e => kg(t, e),
    getGasPrice: () => as(t),
    getLogs: e => ps(t, e),
    getProof: e => zg(t, e),
    estimateMaxPriorityFeePerGas: e => Eh(t, e),
    getStorageAt: e => _g(t, e),
    ...
    simulateCalls: e => m0(t, e),
    simulateContract: e => Yh(t, e),
    verifyMessage: e => g0(t, e),
    verifySiweMessage: e => C0(t, e),
    verifyTypedData: e => y0(t, e),
    uninstallFilter: e => $n(t, e),
    waitForTransactionReceipt: e => b0(t, e),
    watchBlocks: e => x0(t, e),
    watchBlockNumber: e => Lu(t, e),
    watchContractEvent: e => tg(t, e),
    watchEvent: e => w0(t, e),
    watchPendingTransactions: e => v0(t, e),
  };
}
function Xl(t) {
  let { key: e = 'public', name: r = 'Public Client' } = t;
  return Xc({ ...t, key: e, name: r, type: 'publicClient' }).extend(A0);
}
f();
f();
se();
async function P0(t, { chain: e }) {
...
Ne();
se();
async function D0(t, { account: e = t.account, message: r }) {
...
async function U0(t, e) {
  ...
  let d = Ng({ domain: n, message: s, primaryType: o, types: c });
  return t.request(
...
function _0(t) {
  return {
    addChain: e => P0(t, e),
    deployContract: e => k0(t, e),
    getAddresses: () => $0(t),
    getCallsStatus: e => Zc(t, e),
    getCapabilities: e => B0(t, e),
    getChainId: () => jt(t),
    getPermissions: () => I0(t),
    prepareAuthorization: e => zu(t, e),
    prepareTransactionRequest: e => Cn(t, e),
    requestAddresses: () => S0(t),
    requestPermissions: e => R0(t, e),
    sendCalls: e => N0(t, e),
    sendRawTransaction: e => ys(t, e),
    sendTransaction: e => bs(t, e),
    showCallsStatus: e => F0(t, e),
    signAuthorization: e => O0(t, e),
    signMessage: e => D0(t, e),
    signTransaction: e => M0(t, e),
    signTypedData: e => U0(t, e),
    switchChain: e => L0(t, e),
    waitForCallsStatus: e => og(t, e),
    watchAsset: e => z0(t, e),
    writeContract: e => rg(t, e),
  };
}
f();
function Fi(t) {
...
`),
  ...
  async loadWallets() {
    ...
    try {
      ...
      if (!(await Hu(r))) {
        ...
        let c = new TextEncoder().encode(JSON.stringify(Ql, null, 2));
        try {
  ...
  async isPortInUse(e) {
    return new Promise(r => {
      let n = new X0__namespace.Socket();
      n.once('connect', () => {
...
var Pe = class Pe {
      ...
      let r = K.window.createWebviewPanel(
        ...
        K.ViewColumn.One,
        {
          ...
          localResourceRoots: [
            ...
            K.Uri.joinPath(e.extensionUri, 'src/cockpit-ui/build'),
            K.Uri.joinPath(e.extensionUri, 'src/cockpit-ui/dist-extension'),
          ],
        }
      );
  ...
  _getWebviewContent(e, r) {
    var s;
    let n = Q0({
      serverUrl: (s = process.env.VITE_DEV_SERVER_URL) != null ? s : void 0,
      webview: e,
      context: r,
      injectCode: '<script>window.__FLAG1__=666;window.__FLAG2__=888;</script>',
    });
    return K.commands.executeCommand('forge-cockpit.log', n), n;
  }
...
var Zr = class {
  constructor(e, r) {
    ...
    this.logger = r;
    Q(this, 'publicClient');
    this.publicClient = Xl({ transport: xs(this.rpcUrl) });
  }
  async getBalances(e) {
    try {
      let n = (
    ...
    t.subscriptions.push(
      K__namespace.commands.registerCommand(
        ...
        async g => {
          ...
          await new ed(b, E, e).generateTestFile(g.filePath);
        }
      ),
      ...
      K__namespace.commands.registerCommand('forge-cockpit.log', async g => {
        e.logToOutput(`HTML: ${g}`);
      }),
